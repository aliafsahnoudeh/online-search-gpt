...
from gpt_investigator.master.prompts import *
from gpt_investigator.scraper.scraper import Scraper
from gpt_investigator.utils.llm import *
...
def get_retriever(retriever):
    ...
    match retriever:
        case "google":
            from gpt_investigator.retrievers import GoogleSearch

            retriever = GoogleSearch
        case "searx":
            from gpt_investigator.retrievers import SearxSearch

            retriever = SearxSearch
        case "serpapi":
            from gpt_investigator.retrievers import SerpApiSearch

            retriever = SerpApiSearch
        case "googleSerp":
            from gpt_investigator.retrievers import SerperSearch

            retriever = SerperSearch
        case "duckduckgo":
            from gpt_investigator.retrievers import Duckduckgo

            retriever = Duckduckgo
        case "bing":
            from gpt_investigator.retrievers import BingSearch

            retriever = BingSearch
        case "tavily":
            from gpt_investigator.retrievers import TavilySearch

            retriever = TavilySearch
        case "exa":
            from gpt_investigator.retrievers import ExaSearch

            retriever = ExaSearch
        case "custom":
            from gpt_investigator.retrievers import CustomRetriever
...
async def generate_report(
    ...
    content = f"{generate_answer_prompt(query, context, report_source, cfg.total_words)}"
